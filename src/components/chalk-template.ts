// From: https://github.com/chalk/chalk-template/blob/24a04731402bdd5350a354c52d7c9968b0e2f125/index.js#L1
  ...
  function buildStyle(styles) {
    ...
    for (const [styleName, styles] of Object.entries(enabled)) {
      ...
      if (!(styleName in current)) {
        throw new Error(`Missing format function named: ${styleName}`);
      }
...
function makeChalkTemplate(template: (value: string) => string) {
